...
Imported['StateHelp'] = 1.01;

/*:
 * @plugindesc ver1.01/ステートにヘルプを付け、ステートの詳細を見るための仕組みを追加します。
 * @author Yana
 * 
...
(function(){
	...
	Window_StateHelp.prototype.allBattleMembers = function() {
		return BattleManager.allBattleMembers().filter(function(obj){
			return obj.isAppeared();
		});
	};
