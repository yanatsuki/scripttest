//
//  メニューコマンド並び替え ver1.01
//
// author yana
//

var Imported = Imported || {};
Imported['MenuCommandSort'] = 1.01;

/*:
 * @plugindesc ver1.00/メニューコマンドを並び替えたり表示非表示をオンオフできるようにします。
 * @author Yana
 * 
...
(function(){
	...
	Scene_Menu.prototype.commandCommonMenu = function() {
		...
		var ci = Number(c[2]);
		console.log($gameParty.members()[this._statusWindow.index()]._actorId)
